...
public static class ValidateCommand
{
    ...
    public static async Task<int> RunAsync(SlimShadyConfig config, HttpClient http)
    {
        ...
        Console.WriteLine("SlimShady configuration validation");
    ...
    public static async Task<IReadOnlyList<ValidationCheck>> GatherChecksAsync(SlimShadyConfig config, HttpClient http)
    {
