...
public sealed class SlimShadyFatalException : Exception
{
    /// <summary>Creates the exception with the message shown to the user</summary>
    public SlimShadyFatalException(string message) : base(message)
    { }

    /// <summary>Creates the exception with the message shown to the user and the underlying cause</summary>
    public SlimShadyFatalException(string message, Exception innerException) : base(message, innerException)
    { }
}
