...
/// <summary>Drives the tool-call and tool-result exchange for one unit of work: system and user prompt in, final assistant text out. SlimShady executes every tool call itself and feeds the result back; the model never touches anything directly</summary>
