...
/// <summary>Recoverable model-layer failure (endpoint unreachable, timeout, bad status, empty or malformed reply); callers retry per config and then skip the file, unlike a <see cref="SlimShadyFatalException"/> which aborts the run</summary>
